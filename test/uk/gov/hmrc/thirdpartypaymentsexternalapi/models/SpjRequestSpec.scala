...
class SpjRequestSpec extends UnitSpec {
  ...
  "SpjRequest" - {
    ...
    "SpjRequest3psSa" - {
      ...
      val spjRequest = SpjRequest3psSa("1234567895", 123, testClientJourneyId, Some("someurl"), Some("somurl"))
      val jsValue = Json.parse("""{"utr":"1234567895","amountInPence":123,"clientJourneyId":"aef0f31b-3c0f-454b-9d1f-07d549987a96","returnUrl":"someurl","backUrl":"somurl"}""")

      "serialise to json with optional due date" in {
        Json.toJson(spjRequest) shouldBe Json.parse("""{"utr":"1234567895","amountInPence":123,"clientJourneyId":"aef0f31b-3c0f-454b-9d1f-07d549987a96","returnUrl":"someurl","backUrl":"somurl"}""")
      }

      "serialise to json" in {
        Json.toJson(spjRequest.copy()) shouldBe Json.parse("""{"utr":"1234567895","amountInPence":123,"clientJourneyId":"aef0f31b-3c0f-454b-9d1f-07d549987a96","returnUrl":"someurl","backUrl":"somurl"}""")
      }
    ...
    "SpjRequest3psVat" - {
      ...
      val spjRequest = SpjRequest3psVat("1234567895", 123, testClientJourneyId, Some("someurl"), Some("somurl"))
      ...
      "serialise to json" in {
        Json.toJson(spjRequest.copy()) shouldBe Json.parse("""{"vrn":"1234567895","amountInPence":123,"clientJourneyId":"aef0f31b-3c0f-454b-9d1f-07d549987a96","returnUrl":"someurl","backUrl":"somurl"}""")
      }
