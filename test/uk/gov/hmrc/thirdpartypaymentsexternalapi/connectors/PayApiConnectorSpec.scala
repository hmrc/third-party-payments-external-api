...
class PayApiConnectorSpec extends ItSpec {
  ...
  "payApiConnector" - {
    ...
    "startSelfAssessmentJourney" - {
      ...
      val testSpjRequest3psSa: SpjRequest3psSa =
        SpjRequest3psSa(testReference, testAmountInPence, testClientJourneyId, Some(testFriendlyName), None, None)
      ...
      "should return an SpjResponse given pay-api call succeeds" in {
        ...
        val result: Future[SpjResponse] =
          payApiConnector.startSelfAssessmentJourney(testSpjRequest3psSa)(using HeaderCarrier())
      ...
      "propagate a 5xx error when pay-api returns a 5xx" in {
        ...
        val error: Exception = intercept[Exception](
          payApiConnector.startSelfAssessmentJourney(testSpjRequest3psSa)(using HeaderCarrier()).futureValue
        )
        error.getCause.getMessage should include(
          s"POST of 'http://localhost:${wireMockPort.toString}/pay-api/third-party-software/self-assessment/journey/start' returned 503."
        )
      }
    }
    ...
    "startVatJourney" - {
      ...
      val testSpjRequest3psVat: SpjRequest3psVat =
        SpjRequest3psVat(testReference, testAmountInPence, testClientJourneyId, Some(testFriendlyName), None, None)

      "should return an SpjResponse given pay-api call succeeds" in {
        PayApiStub.stubForStartJourneyVat()

        val expectedResult: SpjResponse = PayApiTestData.spjResponse
        val result: Future[SpjResponse] = payApiConnector.startVatJourney(testSpjRequest3psVat)(using HeaderCarrier())
      ...
      "propagate a 5xx error when pay-api returns a 5xx" in {
        ...
        val error: Exception =
          intercept[Exception](payApiConnector.startVatJourney(testSpjRequest3psVat)(using HeaderCarrier()).futureValue)
        error.getCause.getMessage should include(
          s"POST of 'http://localhost:${wireMockPort.toString}/pay-api/third-party-software/vat/journey/start' returned 503."
        )
      }
    }
    ...
    "startCorporationTaxJourney" - {
      ...
      val testSpjRequest3psCorporationTax: SpjRequest3psCorporationTax = SpjRequest3psCorporationTax(
        testReference,
        testAmountInPence,
        testClientJourneyId,
        Some(testFriendlyName),
        None,
        None
      )
      ...
      "should return an SpjResponse given pay-api call succeeds" in {
        ...
        val expectedResult: SpjResponse = PayApiTestData.spjResponse
        val result: Future[SpjResponse] =
          payApiConnector.startCorporationTaxJourney(testSpjRequest3psCorporationTax)(using HeaderCarrier())
      ...
      "propagate a 5xx error when pay-api returns a 5xx" in {
        ...
        val error: Exception = intercept[Exception](
          payApiConnector.startCorporationTaxJourney(testSpjRequest3psCorporationTax)(using HeaderCarrier()).futureValue
        )
        error.getCause.getMessage should include(
          s"POST of 'http://localhost:${wireMockPort.toString}/pay-api/third-party-software/corporation-tax/journey/start' returned 503."
        )
      }
    }
    ...
    "startEmployersPayAsYouEarnJourney" - {
      ...
      val testSpjRequest3psEmployersPayAsYouEarn: SpjRequest3psEmployersPayAsYouEarn =
      ...
      "propagate a 5xx error when pay-api returns a 5xx" in {
        ...
        val error: Exception = intercept[Exception](
          payApiConnector
            .startEmployersPayAsYouEarnJourney(testSpjRequest3psEmployersPayAsYouEarn)(using HeaderCarrier())
            .futureValue
        )
        error.getCause.getMessage should include(
          s"POST of 'http://localhost:${wireMockPort.toString}/pay-api/third-party-software/employers-pay-as-you-earn/journey/start' returned 503."
        )
      }
    }
  }
