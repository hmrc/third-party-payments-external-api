...
import uk.gov.hmrc.thirdpartypaymentsexternalapi.models.{ClientJourneyId, ThirdPartySoftwareFindByClientIdResponse}
...
class OpenBankingConnector @Inject() (
  ...
  def findJourneyByClient(clientJourneyId: ClientJourneyId)(implicit headerCarrier: HeaderCarrier): Future[ThirdPartySoftwareFindByClientIdResponse] =
    httpClientV2
